...
public class Register {
    ...
    public Boolean registerUser(String Username, String Password, Boolean makeUsernameDynamic)
        ...
        // iam not able to user duration.ofseconds in this class

        WebDriverWait wait = new WebDriverWait(driver, 6);
        wait.until(ExpectedConditions.or(
			ExpectedConditions.textToBePresentInElementLocated(By.id("notistack-snackbar"), "Username already exists"),
